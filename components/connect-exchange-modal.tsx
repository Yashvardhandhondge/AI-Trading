...
export function ConnectExchangeModal({ open, onOpenChange, userId, onSuccess }: ConnectExchangeModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(`Connecting to external backend at https://insertion-elderly-positive-ef.trycloudflare.com for user ${effectiveUserId}`);
      
      if (!proxyServerAvailable) {
        throw new Error("Cannot connect to proxy server at https://insertion-elderly-positive-ef.trycloudflare.com. Make sure it's running.");
      }
        ...
        {!proxyServerAvailable && (
          <Alert variant="destructive" className="mb-4 border-red-500 bg-red-50 dark:bg-red-900/20">
            ...
            <AlertDescription className="text-red-700 dark:text-red-400">
              Cannot connect to proxy server at https://insertion-elderly-positive-ef.trycloudflare.com. Please make sure it's running.
            </AlertDescription>
          </Alert>
        )}
